...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "first_name", "last_name": "last_name", "email": "email@gmail.com"}`,
	})
	repository := usersRepository{}
	user, err := repository.LoginUser("email@gmail.com", "password")
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "first_name", user.FirstName)
	assert.EqualValues(t, "last_name", user.LastName)
